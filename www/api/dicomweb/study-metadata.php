 ...
 * Get Study Metadata API Endpoint
 *
 * GET /api/dicomweb/study-metadata.php
...
try {
    ...
    // Get study metadata
    $metadata = $proxy->getStudyMetadata($studyUID);
    ...
    logMessage("Get study metadata API error: " . $e->getMessage(), 'error', 'dicomweb.log');
    sendErrorResponse('Failed to get study metadata: ' . $e->getMessage(), 500);
}
